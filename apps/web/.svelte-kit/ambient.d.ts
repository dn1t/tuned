...
declare module '$env/static/private' {
	...
	export const JOVIAL_VERSION: string;
	export const INIT_CWD: string;
	export const AUTOJUMP_SOURCED: string;
	export const NVM_CD_FLAGS: string;
	export const TERM: string;
	export const SHELL: string;
	export const JOVIAL_PLUGIN_VERSION: string;
	...
	export const DISABLE_MAGIC_FUNCTIONS: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		TERM_PROGRAM: string;
		NODE: string;
		JOVIAL_VERSION: string;
		INIT_CWD: string;
		AUTOJUMP_SOURCED: string;
		NVM_CD_FLAGS: string;
		TERM: string;
		SHELL: string;
		JOVIAL_PLUGIN_VERSION: string;
		...
		DISABLE_MAGIC_FUNCTIONS: string;
