          ...
          {items.map((item) => {
            return (
              <button
                type="button"
                className={cn(
                  "flex w-full cursor-pointer items-center gap-x-3 rounded-[11px] border border-transparent p-1.75 ring-brand-900 transition focus:border-brand-700 focus:outline-none focus:ring-2",
